...
# -----------------------------------------------------
    # Townhouse general (Таун хаусын бүх зураг)
    # -----------------------------------------------------

    if (
        any(x in t for x in ["таун хаус", "таунхаус", "таун"])
        and any(
            x in t
            for x in [
                "зураг",
        ...
        # Хэрэв тодорхой хэмжээ (212 эсвэл 266) дурдаагүй бол БҮХ таун хаусын зургийг илгээнэ
        if not any(x in t for x in ["212", "213", "266", "267"]):
            return [
                "TOWNHOUSE_212",
                "TOWNHOUSE_212_1",
                "TOWNHOUSE_266",
    ...
    # -----------------------------------------------------
    # Mult house general (Мульт хаусын бүх зураг)
    # -----------------------------------------------------

    if (
        any(x in t for x in ["мульт хаус", "мультхаус", "мульт"])
        and any(
            x in t
            for x in [
                "зураг",
        ...
        # Хэрэв тодорхой мкв/хэмжээ бичээгүй бол БҮХ мульт хаусын зургийг илгээнэ
        mult_sizes = ["100", "116", "120", "125", "126", "136", "178", "189", "192", "198"]
        if not any(size in t for size in mult_sizes):
            return [
                "MULT",
                "MULT_100",
                "MULT_116",
...
# -----------------------------------------------------
    # General m2 / size options (мкв сонголт)
    # -----------------------------------------------------
